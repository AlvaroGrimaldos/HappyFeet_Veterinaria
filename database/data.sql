...
(2, 'Luna', 6, '2021-07-22', 'Hembra', 'https://ejemplo.com/luna.jpg', 'Si'),
(3, 'Rocky', 3, '2019-11-08', 'Macho', 'https://ejemplo.com/rocky.jpg', 'Si'),
(4, 'Mia', 7, '2022-01-30', 'Hembra', 'https://ejemplo.com/mia.jpg', 'No'),
...
(21, 'Thor', 14, '2021-01-15', 'Macho', 'https://ejemplo.com/thor.jpg', 'Si'),
(22, 'Maya', 15, '2020-10-08', 'Hembra', 'https://ejemplo.com/maya.jpg', 'Si'),
...
INSERT INTO centro_veterinario (nit, id, nombre, telefono, direccion, email) VALUES
('900123456-1', 1, 'Centro Veterinario Happy Feet', '6076543210', 'Calle 45 #23-15, Bucaramanga', 'info@sanfrancisco.vet');
...
(7, '2023-07-30', 8, 'Consulta de emergencia por vómito', 'Intoxicación alimentaria leve', 'Tratamiento sintomático', 1),
(8, '2023-08-15', 2, 'Revisión dermatológica', 'Dermatitis alérgica', 'Champú medicinal y antihistamínico', 1),
(9, '2023-09-08', 7, 'Limpieza dental programada', 'Acumulación de sarro', 'Limpieza dental bajo anestesia', 1),
...
(19, '2024-07-12', 8, 'Emergencia por traumatismo', 'Herida cortante en pata', 'Sutura y antibiótico', 1),
(20, '2024-08-25', 2, 'Consulta por letargo', 'Anemia leve', 'Suplemento de hierro', 1),
(21, '2024-09-10', 7, 'Revisión dental', 'Gingivitis moderada', 'Tratamiento periodontal', 1),
...
('Antiparasitario Interno', 6, 'Vermífugo de amplio espectro', 'AnimalCare', 'ANT002', 100, 20, '2025-06-30', 25000.00),
('Antibiótico Injectable', 7, 'Penicilina G sódica', 'MedVet', 'AB003', 30, 5, '2025-03-15', 35000.00),
('Alimento Concentrado Perro', 4, 'Alimento premium para perros adultos', 'PetFood', 'ALI004', 200, 50, '2025-08-20', 65000.00),
('Collar Isabelino', 13, 'Collar de protección post-cirugía', 'VetSupplies', 'COL005', 25, 5, '2026-01-01', 15000.00),
('Desinfectante Quirúrgico', 10, 'Solución antiséptica para cirugía', 'SterileMax', 'DES006', 40, 8, '2025-09-10', 28000.00),
('Suplemento Vitamínico', 9, 'Complejo vitamínico para mascotas', 'VitaPet', 'VIT007', 80, 15, '2025-11-25', 32000.00),
('Champú Medicinal', 16, 'Champú para dermatitis', 'SkinCare', 'CHA008', 35, 10, '2025-07-18', 22000.00),
('Analgésico Oral', 8, 'Tabletas para dolor leve-moderado', 'PainRelief', 'ANA009', 60, 12, '2025-05-30', 18000.00),
('Vacuna Antirrábica', 2, 'Vacuna contra la rabia', 'RabiesVac', 'RAB010', 45, 8, '2025-10-15', 38000.00),
('Colirio Oftálmico', 19, 'Gotas para infecciones oculares', 'EyeCare', 'COL011', 25, 5, '2025-04-22', 20000.00),
('Spray Cicatrizante', 17, 'Spray para acelerar cicatrización', 'HealFast', 'SPR012', 40, 8, '2025-12-08', 26000.00),
('Tranquilizante Suave', 24, 'Sedante para procedimientos menores', 'CalmVet', 'TRA013', 20, 4, '2025-06-12', 42000.00),
('Alimento Gatos Premium', 4, 'Concentrado para gatos adultos', 'FelineFood', 'GAT014', 150, 30, '2025-09-05', 58000.00),
('Jeringa Desechable 5ml', 11, 'Jeringas estériles para inyección', 'MedSupply', 'JER015', 200, 50, '2026-02-28', 2500.00),
('Probiótico Canino', 18, 'Regulador de flora intestinal', 'GutHealth', 'PRO016', 55, 10, '2025-07-30', 35000.00),
('Antipulgas Collar', 21, 'Collar repelente de pulgas', 'FleaFree', 'FLE017', 70, 15, '2025-11-18', 28000.00),
('Pasta Dental Mascotas', 20, 'Dentífrico enzimático', 'DentalCare', 'DEN018', 45, 10, '2025-08-14', 16000.00),
('Vendas Elásticas', 11, 'Material de curación', 'WoundCare', 'VEN019', 100, 20, '2026-03-20', 8000.00),
('Garrapaticida Spray', 22, 'Eliminador de garrapatas', 'TickAway', 'GAR020', 30, 6, '2025-10-25', 31000.00),
('Alimento Cachorros', 4, 'Concentrado para perros jóvenes', 'PuppyGrow', 'CAC021', 120, 25, '2025-12-15', 72000.00),
('Solución Salina', 11, 'Suero fisiológico estéril', 'CleanMed', 'SAL022', 80, 15, '2025-05-18', 12000.00),
('Vermífugo Líquido', 23, 'Antiparasitario interno líquido', 'WormOut', 'VER023', 65, 12, '2025-09-22', 29000.00),
('Termómetro Digital', 12, 'Termómetro para uso veterinario', 'TempCheck', 'TER024', 15, 3, '2026-01-30', 45000.00),
('Esterilizante Instrumental', 25, 'Solución para esterilización', 'SterilMax', 'EST025', 25, 5, '2025-06-28', 38000.00);
...
(12, '2024-02-26 09:15:00', 'Primera vacunación', 3, 12),
(13, '2024-03-01 16:00:00', 'Control de peso', 3, 13),
...
(17, '2024-03-15 09:00:00', 'Revisión anual', 3, 17),
...
(21, '2024-04-02 10:15:00', 'Revisión dental', 3, 21),
...
(25, '2024-04-15 15:00:00', 'Control general', 3, 25);
...
(12, '2024-02-26 09:45:00', 55000.00, 1),
(13, '2024-03-01 16:30:00', 70000.00, 1),
...
(2, 7, NULL, 1, 32000.00, 32000.00),
(2, 1, NULL, 1, 38000.00, 38000.00),
...
(4, 3, NULL, 1, 35000.00, 35000.00),
(4, 5, NULL, 1, 15000.00, 15000.00),
(5, NULL, 'Control post-operatorio', 1, 40000.00, 40000.00),
(5, 3, NULL, 1, 35000.00, 35000.00),
(5, 19, NULL, 1, 8000.00, 8000.00),
(6, 10, NULL, 1, 38000.00, 38000.00),
(6, NULL, 'Consulta vacunación', 1, 30000.00, 30000.00),
(7, NULL, 'Consulta de emergencia', 1, 80000.00, 80000.00),
(7, 9, NULL, 2, 18000.00, 36000.00),
(7, 22, NULL, 1, 12000.00, 12000.00),
(7, 6, NULL, 1, 28000.00, 28000.00),
(8, NULL, 'Consulta dermatológica', 1, 45000.00, 45000.00),
(8, 8, NULL, 1, 22000.00, 22000.00),
(8, 9, NULL, 1, 18000.00, 18000.00),
(8, 6, NULL, 1, 28000.00, 28000.00),
(9, NULL, 'Limpieza dental', 1, 180000.00, 180000.00),
(9, 18, NULL, 1, 16000.00, 16000.00),
(9, 24, NULL, 1, 45000.00, 45000.00),
(10, NULL, 'Consulta ortopédica', 1, 55000.00, 55000.00),
(10, 9, NULL, 2, 18000.00, 36000.00),
(11, 17, NULL, 1, 28000.00, 28000.00),
(11, NULL, 'Consulta general', 1, 32000.00, 32000.00),
(12, 1, NULL, 1, 45000.00, 45000.00),
(12, NULL, 'Primera consulta', 1, 25000.00, 25000.00),
(13, NULL, 'Consulta nutricional', 1, 40000.00, 40000.00),
(13, 4, NULL, 1, 65000.00, 65000.00),
(14, NULL, 'Cirugía de castración', 1, 250000.00, 250000.00),
(14, 3, NULL, 1, 35000.00, 35000.00),
(15, 11, NULL, 1, 20000.00, 20000.00),
(15, NULL, 'Consulta oftalmológica', 1, 45000.00, 45000.00),
(16, 2, NULL, 1, 25000.00, 25000.00),
(16, NULL, 'Consulta general', 1, 35000.00, 35000.00),
(17, NULL, 'Revisión anual completa', 1, 70000.00, 70000.00),
(17, 10, NULL, 1, 38000.00, 38000.00),
...
(19, 3, NULL, 2, 35000.00, 70000.00),
(19, 19, NULL, 1, 8000.00, 8000.00),
(20, NULL, 'Consulta general', 1, 40000.00, 40000.00),
(20, 16, NULL, 1, 35000.00, 35000.00),
(21, NULL, 'Tratamiento dental', 1, 90000.00, 90000.00),
(21, 18, NULL, 1, 16000.00, 16000.00),
(21, 24, NULL, 1, 45000.00, 45000.00),
(22, 20, NULL, 1, 31000.00, 31000.00),
(22, NULL, 'Consulta dermatológica', 1, 42000.00, 42000.00),
(23, NULL, 'Consulta respiratoria', 1, 50000.00, 50000.00),
(23, 23, NULL, 1, 29000.00, 29000.00),
(24, 1, NULL, 1, 45000.00, 45000.00),
(24, NULL, 'Segunda consulta', 1, 20000.00, 20000.00),
(25, NULL, 'Control general', 1, 35000.00, 35000.00),
(25, 7, NULL, 1, 32000.00, 32000.00);